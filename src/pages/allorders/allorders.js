...
var AllOrdersPage = /** @class */ (function (_super) {
    __extends(AllOrdersPage, _super);
    function AllOrdersPage(navProxy, loadingCtrl, events, afAuth, db, navCtrl, http, navParams) {
    ...
    AllOrdersPage.prototype.onSort = function (event) {
        var _this = this;
    ...
    AllOrdersPage.prototype.setPage = function (pageInfo) {
        var _this = this;
    ...
    AllOrdersPage.prototype.getJSON = function () {
        return this.http.get("./assets/data/techologies.json")
            .map(function (res) { return res.json(); });
    };
    AllOrdersPage.prototype.sortTable = function () {
        if (this.sort_num == 1) {
    ...
    AllOrdersPage.prototype.updateFilter = function (event) {
    ...
    AllOrdersPage.prototype.onSpecialAction = function (row, action, rowIndex) {
        if (action == 'delete') {
    ...
    AllOrdersPage.prototype.onShowDetails = function (row, rowIndex) {
        var item = this.rows[rowIndex];
        this.events.publish('order_details', item);
    };
    AllOrdersPage.prototype.getAllOrders = function () {
        var self = this;
    ...
    ], AllOrdersPage.prototype, "table", void 0);
